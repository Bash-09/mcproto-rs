...
define_protocol!(753, Packet753, RawPacket753, RawPacket753Body, Packet753Kind => {
    ...
    PlayBlockDestroyStage, 0x07, Play, ClientBound => PlayDestroyBlockStageSpec {
        entity_id: VarInt,
        location: IntPosition,
        destroy_stage: i8,
    },
    ...
    PlayDeleteMessage, 0x19, Play, ClientBound => PlayDeleteMessageSpec {
        signatures: CountedArray<u8, VarInt>
    },
    ...
    PlayDisguisedMessage, 0x1B, Play, ClientBound => PlayDisguisedMessageSpec {
        message: Chat,
        chat_type: VarInt,
        chat_type_name: Chat,
    ...
    PlayInitWorldBorder, 0x22, Play, ClientBound => WorldBorderInitializeSpec,
    ...
    PlayChunkData, 0x24, Play, ClientBound => PlayChunkDataWrapper {
        ...
        block_entities: CountedArray<, VarInt>,
        trust_edges: bool,
        sky_light_mask: BitSet,
        block_light_mask: BitSet,
        empty_sky_light_mask: BitSet,
        empty_block_light_mask: BitSet,
        sky_light_arrays: CountedArray<CountedArray<u8, VarInt>, VarInt>,
        block_light_arrays: CountedArray<CountedArray<u8, VarInt>, VarInt>,
    },
    PlayEffect, 0x25, Play, ClientBound => PlayEffectSpec { // aka World Event
        effect_id: i32,
        location: IntPosition,
        data: i32,
    ...
    PlayPlayerChatMessage, 0x35, Play, ClientBound => PlayPlayerChatMessageSpec {
        ...
        previous_messages: ChatMessagePrevious,
        other
    },
...
type BitSet = CountedArray<i64, VarInt>;
